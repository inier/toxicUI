...
export const IconButton = () => (
  <div className='container button'>
    ...
    <Button icon='https://img.yzcdn.cn/toxic/logo.png' type='primary'>
      Custom Icon Button
    </Button>
  </div>
);
...
export const ButtonURL = () => (
  <div className='container column button'>
    <Button tag='a' url='https://github.com/mxdi9i7/toxic-react'>
      Button with URL
    </Button>
    <Button tag='a' replace url='https://github.com/mxdi9i7/toxic-react'>
